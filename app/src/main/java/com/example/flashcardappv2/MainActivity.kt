...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deck = p2.PerfectSquaresDeck(listOf(1,2,3,4,5)) // TODO: provide an instance of an IDeck here! EX: PerfectSquaresDeck(5)
...
@Composable
fun SimpleFlashcards(deck: p2.IDeck) {
    ...
    var topCard: p2.IDeck by remember {
        mutableStateOf(deck)
    }
    ...
    fun SimpleCard() {
        ...
        fun cardText(getFront: Boolean = false): String {
            ...
            if(topCard.getState() == p2.DeckState.EXHAUSTED) {
            ...
            if(topCard.getState() == p2.DeckState.ANSWER && getFront) {
                return front
            }
        ...
        fun onClickCard() {
            ...
            if(topCard.getState() == p2.DeckState.QUESTION) {
        ...
        Row (modifier = Modifier.padding(10.dp))
        {
            ...
            if(topCard.getState() == p2.DeckState.EXHAUSTED) {
                ...
                Button(
                    ...
                    enabled = topCard.getState() == p2.DeckState.ANSWER,
